...
- This package is **SPOT only**. It does **not** implement Kraken Futures.
- Unofficial project. Not affiliated with Kraken.

Badges

- CI: https://github.com/<ORG>/<REPO>/actions/workflows/ci.yml/badge.svg
- Coverage (local badge file): ./badges/coverage.svg
...
- For trading: consider enabling cancel_all_orders_after and refreshing it periodically.
